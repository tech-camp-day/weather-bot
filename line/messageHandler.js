...
function handleFollow(event) {
  reply(event, 'สวัสดีครับ ผมคือ Weather Bot คุณสามารถเลือกจังหวัดที่ต้องการรับข้อมูลอากาศได้เลยครับ', 'คุณพี่อยู่จังหวัดอะไรครับ?');
}
...
function handleMessage(event) {
  ...
  if (newProvince) {
    ...
    if (currentProvince) {
      ...
      reply(event, `เปลี่ยนจากจังหวัด${currentProvince.name}เป็นจังหวัด${newProvince.name} เรียบร้อย ผมจะส่งข้อมูลอากาศให้คุณทุกวันครับ`);
    } else {
      createUser(event.source.userId, newProvince.id);
      reply(event, `เลือกจังหวัด${newProvince.name}เรียบร้อย ผมจะส่งข้อมูลอากาศให้คุณทุกวันครับ`);
    }
  } else {
